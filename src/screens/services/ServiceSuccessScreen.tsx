...
export function ServiceSuccessScreen({navigation}: any) {
  ...
  return (
    <BackgroundScreen contentContainerStyle={styles.content}>
      ...
      <Text style={styles.text}>Your {lastRequest?.title || 'service'} request has been submitted. Expected response: ~10 minutes.</Text>
      <SecondaryButton label="Back to Services" onPress={() => navigation.popToTop()} />
    </BackgroundScreen>
  );
}
